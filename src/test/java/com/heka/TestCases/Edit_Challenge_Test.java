...
public class Edit_Challenge_Test extends base {
	...
	public void edit_Challenge() throws IOException, InterruptedException {
		...
		log.info("Edit button clicked to edit the Challenge");

		// Enter challenge description
		challenge.description().click();
		challenge.description().sendKeys("5000_Steps_For_Ten_Points");
		...
		// Challenge points
		challenge.challengePoints().sendKeys("29");
		Thread.sleep(3000);
		log.info("Points edited from 10 to 29");

		// Challenge goal
		challenge.challengeStepsGoal().sendKeys("6000");
		Thread.sleep(3000);
		log.info("Steps goal edited from 5000 to 6000");

		// Enter max challenge points
		challenge.maxChallengePoints().sendKeys("999");	
		Thread.sleep(3000);
