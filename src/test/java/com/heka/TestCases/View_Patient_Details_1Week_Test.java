...
public class View_Patient_Details_1Week_Test extends base {
	public static Logger log = LogManager.getLogger(View_Patient_Details_1Week_Test.class.getName());
	base b = new base();

	@BeforeMethod
	public void setUp() throws IOException {
		log.info("========== VIEW PATIENT DETAILS 1 WEEK TEST START HERE =========");
	...
	@Test
	public void viewPatientOneWeekData() throws IOException, InterruptedException {
		...
		// Selecting 1 Week data
		WebElement dropdown = details.selectPeriodDropdownField();
		Select sel = new Select(dropdown);
		sel.selectByVisibleText("1 Week");
		log.info("1 Week selected to view patient's one week data");
		Thread.sleep(5000);
	...
	public void tearDown() {
		...
		log.info("========== VIEW PATIENT DETAILS 1 WEEK TEST ENDS HERE ==========");
		System.out.println("##############################################################################################################################################");
