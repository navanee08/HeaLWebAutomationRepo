...
public class Add_Users_And_Run_Challenge_Test extends base {
	...
	@Test(timeOut=150000)
	public void add_Users_And_Run_Challenge() throws IOException, InterruptedException {
		...
		activeChallenge.selectByValue("1: Object");
		Thread.sleep(5000);
		...
		Thread.sleep(10000);
		log.info("Clicked on ALL USERS TO CHALLENGE button to add all users to challenge");
		...
		Thread.sleep(5000);
		log.info("Run button is clicked");
		
		//Switch to Do you want to run pontification? alert pop up window
		users.switchToWindow();
		Thread.sleep(5000);				
	...
	public void tearDown() {
		...
		log.info("===================ADD USERS TO CHALLENGE AND RUN PONTIFICATION TUN TEST ENDS HERE=====================");
		System.out.println("##############################################################################################################################################");
